...
--
-- Group.new("MiniDiffOverChange", nil, Colors.green_50)
-- Group.new("MiniDiffOverContextBuf", nil, Colors.red_50)
-- Group.new("MiniDiffSignAdd", Colors.red)
-- Group.new("MiniDiffSignDelete", Colors.green)
-- Group.new("MiniDiffOverContext", nil, Colors.green_25)
-- Group.new("MiniDiffOverChangeBuf", nil, Colors.red_50)
-- Group.new("MiniDiffOverDelete", nil, Colors.green_50)
--
-- local cache = {}
--
